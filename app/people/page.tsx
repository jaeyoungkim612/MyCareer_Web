            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-6">
                ...
                <div className="flex items-baseline gap-1 mr-6">
                  <span className="text-lg font-bold text-orange-600 dark:text-orange-400">{peopleScore?.currentScore}</span>
                  <span className="text-sm font-medium text-orange-400/70">/ {peopleScore?.targetScore}</span>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <Dialog>
                  ...
                  <DialogContent className="max-w-lg">
                    <DialogHeader>
                      <DialogTitle className="text-orange-700 dark:text-orange-300">People 점수 예시</DialogTitle>
                    </DialogHeader>
