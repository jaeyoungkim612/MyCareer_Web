...
export default function IndustrySelfAssessmentTab({ empno: propEmpno, readOnly = false }: IndustrySelfAssessmentTabProps = {}) {
  ...
  const handleReopenMid = () => handleReopen("industry_tl_mid_assessments", "중간평가", () => { setIsEditingMid(true); setTabValueMid("edit") })
  const handleReopenFinal = () => handleReopen("industry_tl_final_assessments", "기말평가", () => { setIsEditingFinal(true); setTabValueFinal("edit") })
  // 임시저장/제출 (upsert로 저장)
